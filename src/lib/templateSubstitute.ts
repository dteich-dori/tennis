...
export const TEMPLATE_VARIABLES: Array<{
  ...
  { token: "balance",     description: "Outstanding Don's balance owed (fee − deposits − credit)", example: "$1,000" },
  { token: "credit",      description: "Credit from the previous year's distribution", example: "$75" },
  ...
  { token: "soloBalance", description: "Outstanding solo balance due (solo fee − solo deposit)", example: "$400" },
